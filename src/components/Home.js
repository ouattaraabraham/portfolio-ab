        ...
        <div className='m-auto flex flex-col gap-[5vw] lg:gap-0 lg:grid lg:grid-cols-3  '>       
            <div className='flex flex-col gap-[2vw] mobile:gap-[3vw] lg:col-span-2   '>
                ...
                transition={{delay:0.8, duration:0.5}} className='text-[4vw] mobile:text-[3vw] md:text-[2.5vw] flex gap-[5vw] justify-center items-center py-5'>
                    <span className={`relative overflow-hidden rounded-lg w-[25%] h-[2em] lg:h-[1.9em]    flex justify-center items-center before:flex before:justify-center before:items-center before:rounded-lg before:w-[200px] before:blur-sm before:h-4  before:animate-rotate1 before:absolute before:bg-gradient 
                     ...
                     <span className={`relative overflow-hidden rounded-lg w-[25%] h-[2em] lg:h-[1.9em]    flex justify-center items-center before:flex before:justify-center before:items-center before:rounded-lg before:w-[200px] before:blur-sm before:h-3 before:rotate-180  before:animate-rotate2 before:absolute before:bg-gradient 
