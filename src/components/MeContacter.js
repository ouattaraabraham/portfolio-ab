...
function MeContacter() {
  ...
  <motion.div
   ...
   id='Contact' className='px-5 sm:px-10 md:px-7  pb-12	'>
    <div
    //  initial={{}}
    // transition={{duration: 1.5,}}
    //  whileInView={{borderColor:colors}}
     className='py-8 mx-auto text-center text-slate-10  items-center sm:py-10  sm:max-w-2xl'>
      <h2 className='text-lg'>Me contacter</h2>
      <p className='lg:text-lg py-5'>
      Vous avez une question, une proposition, 
      Je suis toujours ouvert à discuter du travail de conception ou des opportunités de partenariat.      </p>
